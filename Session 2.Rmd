...
## Leider ändern sich die Ländernamen, zB United Kingdom wird nur United... Ist das jetzt schlimm?
##Nochmal den bereinigten Dataframe anschauen - weniger Zeilen, aber zB mehr Einträge bei USA und Germany.
```{r}
(users %>%
  group_by(country) %>%
  summarize(n = n()) %>%
